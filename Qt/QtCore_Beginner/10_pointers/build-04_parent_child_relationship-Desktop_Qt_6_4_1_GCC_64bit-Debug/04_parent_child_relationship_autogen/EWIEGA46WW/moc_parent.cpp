...
#include <memory>
#include "../../../04_parent_child_relationship/parent.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Parent_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Parent_t qt_meta_stringdata_Parent = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Parent[] = {
...
Q_CONSTINIT const QMetaObject Parent::staticMetaObject = { {
    ...
    qt_meta_stringdata_Parent.offsetsAndSizes,
    qt_meta_data_Parent,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Parent_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Parent, std::true_type>
    >,
    nullptr
} };
