...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Dog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Dog_t qt_meta_stringdata_Dog = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Dog[] = {
...
Q_CONSTINIT const QMetaObject Dog::staticMetaObject = { {
    ...
    qt_meta_stringdata_Dog.offsetsAndSizes,
    qt_meta_data_Dog,
    qt_static_metacall,
    nullptr,
...
void Dog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Dog::*)();
            if (_t _q_method = &Dog::bark; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
