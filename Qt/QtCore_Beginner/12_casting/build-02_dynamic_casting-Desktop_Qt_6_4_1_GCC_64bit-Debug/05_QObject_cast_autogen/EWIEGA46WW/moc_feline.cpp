...
#include <memory>
#include "../../../05_QObject_cast/feline.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Feline_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Feline_t qt_meta_stringdata_Feline = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Feline[] = {
...
Q_CONSTINIT const QMetaObject Feline::staticMetaObject = { {
    ...
    qt_meta_stringdata_Feline.offsetsAndSizes,
    qt_meta_data_Feline,
    qt_static_metacall,
    nullptr,
